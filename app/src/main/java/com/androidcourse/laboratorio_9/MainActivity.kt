package com.androidcourse.laboratorio_9
...
import com.androidcourse.laboratorio_9.Interface.PostApiService
import com.androidcourse.laboratorio_9.Modulos.ScreenPost
import com.androidcourse.laboratorio_9.Modulos.ScreenPosts
import com.androidcourse.laboratorio_9.ui.theme.Laboratorio_9Theme
...
fun ProgPrincipal9(){
    ...
    var retrofit = Retrofit.Builder().baseUrl(urlBase)
        .addConverterFactory(GsonConverterFactory.create()).build()
    val servicio = retrofit.create(PostApiService::class.java) //inicialiaza el servicio api creado en retrofit
